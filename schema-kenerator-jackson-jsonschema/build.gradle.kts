...
dokka {
    dokkaPublications.html {
        outputDirectory = file("$rootDir/docs/dokka/schema-kenerator-jackson-jsonschema")
    }
}
...
mavenPublishing {
    ...
    pom {
        name.set("$projectNameBase Jackson JSON-Schema")
        description.set("$projectDescriptionBase - adds support for Jackson specific for json-schemas")
