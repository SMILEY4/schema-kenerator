...
tasks.withType<DokkaTask>().configureEach {
    outputDirectory.set(file("$rootDir/docs/dokka/schema-kenerator-serialization"))
}
...
mavenPublishing {
    ...
    signAllPublications()
    coordinates(projectGroupId, "$projectArtifactIdBase-serialization", projectVersion)
    pom {
        name.set("$projectNameBase Kotlinx-Serialization")
        description.set("$projectDescriptionBase - analyzes types using kotlinx-serialization")
